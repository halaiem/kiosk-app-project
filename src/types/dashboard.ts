export type UserRole = 'dispatcher' | 'technician' | 'admin' | 'irida_tools' | 'mechanic';
...
export type TechnicianTab = 'service_requests' | 'routes' | 'documents' | 'vehicles' | 'drivers' | 'schedule' | 'daily_assignment' | 'diagnostics' | 'notifications' | 'dash_messages';
export type AdminTab = 'users' | 'settings' | 'servers' | 'logs' | 'diagnostic_apis' | 'admin_vehicles' | 'notifications' | 'dash_messages' | 'service_requests';
...
export type MechanicTab = 'service_requests' | 'auto_diagnostics' | 'service_log' | 'ts_docs' | 'email' | 'notifications' | 'dash_messages';
