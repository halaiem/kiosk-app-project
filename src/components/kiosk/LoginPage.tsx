      ...
      <div className="relative z-10 w-[40%] flex flex-col items-center justify-center gap-8 px-8">
        ...
        {settings.carrierLogo && (
          <>
            <div className="flex flex-col items-center gap-4">
              ...
              <span className="text-2xl font-bold text-foreground tracking-tight text-center">{settings.carrierName}</span>
            </div>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-foreground tracking-tight">ИРИДА</div>
            <div className="text-base text-muted-foreground mt-1">Мобильные рабочие места</div>
          </div>
        </div>
      </div>
